  ...
  return (
    <div className="row">
      ...
      <div className="row__posters" ref={Scroller}>
        ...
        {showfetchedAction.loading === true ? (
          <h1>loading</h1>
        ) : (
            showfetchedAction.actions.map((movie) => {
            return (
...
const mapDispatchToProps = (dispatch) => {
  return {
    onFetchingAction: (fetchUrl) => {
      dispatch(actionCreator.FetchDataAction(fetchUrl));
    },
  };
};
